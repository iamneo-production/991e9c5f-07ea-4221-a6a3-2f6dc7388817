...
export class LoginService {
  private loginurl = "https://8080-eabbdcbebcdababecfbdcbbefdaddee.project.examly.io/api/user/login";
  private registerurl="https://8080-eabbdcbebcdababecfbdcbbefdaddee.project.examly.io/api/user/signup";
